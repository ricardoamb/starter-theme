...
class acf_field_date_and_time_picker extends acf_field {
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// script
		wp_enqueue_script('acf-timepicker', get_template_directory_uri() . '/inc/plugins/acf/assets/inc/timepicker/jquery-ui-timepicker-addon.min.js', array('jquery-ui-datepicker'), $version);

		// style
		wp_enqueue_style('acf-timepicker',get_template_directory_uri() . '/inc/plugins/acf/assets/inc/timepicker/jquery-ui-timepicker-addon.min.css', '', $version);
