	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		if( $major == 4 ) {
			...
			$version = '4.0';
			$script = get_template_directory_uri() . "/inc/plugins/acf/assets/inc/select2/4/select2.full{$min}.js";
			$style = get_template_directory_uri() . "/inc/plugins/acf/assets/inc/select2/4/select2{$min}.css";
		
		// v3
		} else {
			
			$version = '3.5.2';
			$script = get_template_directory_uri() . "/inc/plugins/acf/assets/inc/select2/3/select2{$min}.js";
			$style = get_template_directory_uri() . "/inc/plugins/acf/assets/inc/select2/3/select2.css";
