...
class acf {
	...
	*/
	...
	function register_assets() {
		...
		// scripts
		wp_register_script('acf-input', get_template_directory_uri() . "/inc/plugins/acf/assets/js/acf-input{$min}.js", array('jquery', 'jquery-ui-core', 'jquery-ui-sortable', 'jquery-ui-resizable'), $version );
		wp_register_script('acf-field-group', get_template_directory_uri() . "/inc/plugins/acf/assets/js/acf-field-group{$min}.js", array('acf-input'), $version );
		
		
		// styles
		wp_register_style('acf-global', get_template_directory_uri() . '/inc/plugins/acf/assets/css/acf-global.css', array(), $version );
		wp_register_style('acf-input', get_template_directory_uri() . '/inc/plugins/acf/assets/css/acf-input.css', array('acf-global'), $version );
		wp_register_style('acf-field-group', get_template_directory_uri() . '/inc/plugins/acf/assets/css/acf-field-group.css', array('acf-input'), $version );
